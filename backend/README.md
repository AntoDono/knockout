...
The sample data simulates a 90-day period for a TKOS patient (Dishita) on nadolol + flecainide with an ICD. When the real database layer is ready, swap `sample_data` for actual queries — `builder.py` works unchanged.
