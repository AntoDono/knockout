...
const initialCareTeam: Clinician[] = [
  { name: "Dr. Aarav Mehta", role: "Pediatric Cardiologist", email: "aarav.mehta@childrens.org" },
  { name: "Dr. Priya Sharma", role: "Electrophysiologist", email: "priya.sharma@heartcenter.org" },
];

const initialGuardians: Guardian[] = [
  { name: "Ravi Agarwal", relationship: "Father", phone: "(555) 234-5678" },
  { name: "Sunita Agarwal", relationship: "Mother", phone: "(555) 234-5679" },
  { name: "Ananya Patel", relationship: "Best Friend", phone: "(555) 867-5309" },
];
